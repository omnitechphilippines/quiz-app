          ...
          Expanded(
            child: Column(
              ...
              children: <Widget>[
                ...
                Text('User: ${itemData['user_answer'] as String}', style: const TextStyle(color: Color.fromARGB(255, 202, 171, 252))),
                Text('Correct: ${itemData['correct_answer'] as String}', style: const TextStyle(color: Color.fromARGB(255, 181, 254, 246))),
              ],
            ),
          ),
        ],
